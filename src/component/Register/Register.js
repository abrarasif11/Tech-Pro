...
const Register = () => {
    ...
    <h2 class="text-3xl font-semibold text-black capitalize dark:text-white">Register Here</h2>

    <form>
        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols">
            <div>
                <label class="text-gray-700 dark:text-gray-200" for="username"></label>
        ...
        <div class="flex justify-center mt-6">
            <button class="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-sky-700 rounded-md  hover:bg-sky-500 focus:outline-none focus:bg-sky-600">Register</button>
        </div>
    </form>
</section>
    );
